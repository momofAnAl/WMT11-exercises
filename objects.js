...
console.log(Object.entries(updateUser(someUser)));
...
function updateProfile(profile, property, value) {
  profile[property] = value //object[property] = value <- syntax

  return profile;
}

console.log(updateProfile(userProfile, 'location', "Redmond, WA"));
...
function removePassword(object, property) {
...
totalCount = zooAnimals ({lion: 5, tiger: 10, bear: 15});
