...
let lastItem = sampleArray.slice(-1);
...
sampleArray[0] = 42;
sampleArray[sampleArray.length-1] = 42;// cannot use -1 alone have to add .length
console.log(sampleArray);
...
let newArray = [];
// for (let i = startArray; i < i - 1; i = i + 10) {
//     newArray.push(startArray[i])
// }
// console.log(newArray);

for (const num of startArray) {
